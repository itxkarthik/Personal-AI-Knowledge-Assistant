...
def summarize_document_into_note(
	*,
	...
	generated_markdown = _generate_markdown(session=session, user_id=user_id, prompt=prompt, content=document.content)
...
def generate_study_notes_from_content(
	*,
	...
	generated_markdown = _generate_markdown(session=session, user_id=user_id, prompt=prompt, content=source_content)
...
def extract_key_points_and_action_items(
	*,
	...
	markdown = _generate_markdown(session=session, user_id=user_id, prompt=prompt, content=source_content)
